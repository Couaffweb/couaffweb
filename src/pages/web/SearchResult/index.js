		...
		<>
				...
				<div className='container'>
					<div className='row'>
						<div className='col-md-12'>
							<h3 className='title3'>Recommended</h3>
							<div className='owl-sl'>
								<div id='recommended_sli11' className='owl-carousel'>
									<div className='item'>
			...
			<section className='recommended_slider listing11'>
				<div className='container'>
					<div className='row'>
						<div className='col-md-12'>
							<h3 className='title3'>Nail Salons</h3>
							<div className='sortb'>
